...
namespace Igor.RU_2023507013
{
    ...
    {
        private static readonly bool FullReplacement = false;
        private static readonly bool ReviewedDefinitions = true;
        ...
        public ReviewedOverrides(ModContentPack content) : base(content)
        {
            ...
            var harmony = new Harmony("igor.ru.2023507013.overrides");
            ...
            foreach(var directory in content.foldersToLoadDescendingOrder.Select(root => Path.Combine(root,"Languages","Russian")).Where(Directory.Exists))
        ...
        private static void OverrideWordGenders(Tuple<VirtualDirectory,ModContentPack,string> __0,LoadedLanguage __1,Dictionary<string,Gender> ___genders)
        {
            ...
            if(__0.Item2==null || !string.Equals(__0.Item2.PackageId,"starsky.rimworld.ru.2023507013",StringComparison.OrdinalIgnoreCase))return;
