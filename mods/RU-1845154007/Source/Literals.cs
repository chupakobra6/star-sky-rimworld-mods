...
namespace Igor.RU_1845154007
{
    public sealed class LiteralTranslations : Mod
    {
        private static readonly Dictionary<string,Dictionary<string,string>> Methods =
            ...
            { "VFESecurity.CompConcealed+<CompGetGizmosExtra>d__19:MoveNext", new Dictionary<string,string> {
                { "VFES_Transitioning", "chupakobra6_1845154007_Transitioning" }
            } }
            };
        ...
        {
            var harmony = new Harmony("igor.ru.1845154007.literals");
