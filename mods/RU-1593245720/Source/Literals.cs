...
namespace Igor.RU_1593245720
{
    public sealed class LiteralTranslations : Mod
    {
        private static readonly Dictionary<string,Dictionary<string,string>> Methods =
            ...
            { "aRandomKiwi.HFM.HuntingForMe:SettingsCategory", new Dictionary<string,string> {
                { "Hunt For Me", "Hunt for Me — охота питомцев" }
            } }
            };
        ...
        {
            var harmony = new Harmony("igor.ru.1593245720.literals");
