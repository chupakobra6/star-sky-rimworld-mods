...
namespace Igor.RU_1814100216
{
    ...
    public sealed class ReviewedOverrides : Mod
    {
        ...
        private static readonly bool ReplaceDirectories = true;
        ...
        public ReviewedOverrides(ModContentPack content) : base(content)
        {
            ...
            var harmony = new Harmony("igor.ru.1814100216.overrides");
        ...
        private static void OverrideWordGenders(Tuple<VirtualDirectory,ModContentPack,string> __0,LoadedLanguage __1,Dictionary<string,Gender> ___genders)
        {
            ...
            if(__0.Item2==null || !string.Equals(__0.Item2.PackageId,"starsky.rimworld.ru.1814100216",StringComparison.OrdinalIgnoreCase))return;
