...
namespace Igor.RU_1814100216
{
    public sealed class LiteralTranslations : Mod
    {
        private static readonly Dictionary<string,Dictionary<string,string>> Methods =
            ...
            { "LetsGoExplore.MotherAmbrosiaLGE+<GetGizmos>d__8:MoveNext", new Dictionary<string,string> {
                { "DEBUG: Spawn pawn", "ОТЛАДКА: создать животное" }
            } },
            { "LetsGoExplore.WorldObject_ResearchRequestLGE:Outcome_Success", new Dictionary<string,string> {
                { "No available research :(", "Нет доступных исследований" }
            } },
            { "LetsGoExplore.WorldObject_ResearchRequestLGE:Outcome_Triumph", new Dictionary<string,string> {
                { "No available research :(", "Нет доступных исследований" }
            } },
            { "LetsGoExplore.CaravanArrivalAction_VisitInterceptedMessageLGE:get_Label", new Dictionary<string,string> {
                { "VisitPeaceTalks", "chupakobra6_1814100216_VisitMessageSite" }
            } },
            { "LetsGoExplore.CaravanArrivalAction_VisitInterceptedMessageLGE:GetFloatMenuOptions", new Dictionary<string,string> {
                { "VisitPeaceTalks", "chupakobra6_1814100216_VisitMessageSite" }
            } },
            { "LetsGoExplore.CaravanArrivalAction_VisitResearchRequest:get_Label", new Dictionary<string,string> {
                { "VisitPeaceTalks", "chupakobra6_1814100216_VisitResearch" }
            } },
            { "LetsGoExplore.CaravanArrivalAction_VisitResearchRequest:GetFloatMenuOptions", new Dictionary<string,string> {
                { "VisitPeaceTalks", "chupakobra6_1814100216_VisitResearch" }
            } },
            { "LetsGoExplore.WorldObject_ResearchRequestLGE:Notify_CaravanArrived", new Dictionary<string,string> {
                { "MessagePeaceTalksNoDiplomat", "chupakobra6_1814100216_NoResearcher" }
            } },
            { "LetsGoExplore.GoExplore:DoSettingsWindowContents", new Dictionary<string,string> {
                { "LetterLabelInterceptedMessageLGE", "chupakobra6_1814100216_ResearchRequest" }
            } }
            };
        ...
        {
            var harmony = new Harmony("igor.ru.1814100216.literals");
